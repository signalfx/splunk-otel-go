...
This release upgrades [OpenTelemetry Go to v1.36.0/v0.58.0][otel-v1.35.0] and [v0.12.1][otel-log-v0.12.1]
...
[Unreleased]: https://github.com/signalfx/splunk-otel-go/compare/v1.26.0...HEAD
