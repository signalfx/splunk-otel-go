...
require (
	...
	github.com/signalfx/splunk-otel-go/instrumentation/github.com/confluentinc/confluent-kafka-go/v2/kafka/splunkkafka v1.12.0
...
require (
	...
	github.com/docker/cli v24.0.8+incompatible // indirect
