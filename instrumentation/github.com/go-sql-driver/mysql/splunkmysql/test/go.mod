...
require (
	...
	github.com/signalfx/splunk-otel-go/instrumentation/database/sql/splunksql v1.5.0
	github.com/signalfx/splunk-otel-go/instrumentation/github.com/go-sql-driver/mysql/splunkmysql v1.5.0
