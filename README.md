...
The official documentation for this distribution can be found
in the 
[Splunk Observability Docs site](https://docs.splunk.com/Observability/gdi/get-data-in/application/go/get-started.html).
